...
>(({ onRouteSaved }, ref) => {
  ...
  const updateContent = () => {
    if (editorRef.current) {
      ...
      setRouteData((prev) => ({ ...prev, description: htmlContent }));
    }
  };
  ...
  const handleAddTag = () => {
    if (tagInput.trim() && !routeData.tags.includes(tagInput.trim())) {
      setRouteData((prev) => ({
        ...prev,
  ...
  const handleAddKeyword = () => {
    if (
      keywordInput.trim() &&
      !routeData.seoKeywords?.includes(keywordInput.trim())
    ) {
      setRouteData((prev) => ({
        ...prev,
  ...
  const handleSave = async () => {
    if (
      ...
      alert("Please fill in the route name, from, and to fields");
      return;
    }
      ...
      <div className="bg-gray-800 shadow-sm border-b border-gray-700 p-4">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold text-yellow-400">
            {routeData.id ? "Edit Route" : "Create New Route"}
          </h2>
          <button
            onClick={handleClose}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Enter route name (e.g., Mumbai to Delhi)"
              />
            </div>
            ...
            <div className="border-t border-gray-600 pt-6">
              ...
              <div className="mb-4">
                ...
                <textarea
                  value={routeData.seoDescription || ""}
                  onChange={(e) =>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {routeData.seoKeywords?.map((keyword, index) => (
                    <span
                      key={index}
              ...
              <div className="border border-gray-600 rounded-lg overflow-hidden bg-gray-800">
                ...
                >
                  ...
                  <div
                    ...
                    className="w-full h-[400px] p-8 resize-none focus:outline-none focus:ring-0 text-white leading-relaxed overflow-y-auto bg-gray-900"
                    style={{
                      minHeight: "400px",
                    ...
                    data-placeholder="Describe the route details, attractions, and travel information..."
                  />
                  <style jsx>{`
